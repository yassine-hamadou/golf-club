            ...
            <Col span={24} lg={16}>
              ...
              */}
                ...
                >
                  ...
                  <Form.Item
                    name='player2Membership'
                    label='Player 2'
                    rules={[{required: true, message: 'Missing player2 Membership'}]}
                  >
                    <Select
                      options={memberships}
                  ...
                  {player2Membership === 'member' ? (
                    <Form.Item
                      name='player2'
                      label='Name'
                      rules={[{required: true, message: 'Missing player2'}]}
                    >
                  ...
                  <Form.Item
                    name='player3Membership'
                    label='Player 3'
                    rules={[{required: true, message: 'Missing player3 Membership'}]}
                  >
                    <Select
                      options={memberships}
                  ...
                  {player3Membership === 'member' ? (
                    <Form.Item
                      name='player3'
                      label='Name'
                      rules={[{required: true, message: 'Missing player3'}]}
                    >
                  ...
                  <Form.Item
                    name='player4Membership'
                    label='Player 4'
                    rules={[{required: true, message: 'Missing player4 Membership'}]}
                  >
                    <Select
                      options={memberships}
                  ...
                  {player4Membership === 'member' ? (
                    <Form.Item
                      name='player4'
                      label='Name'
                      rules={[{required: true, message: 'Missing player4'}]}
                    >
